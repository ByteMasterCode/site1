...
export default function Footer () {
    ...
    if (lang === undefined) {lang ='uz';}
        ...
        return (
            <footer className="relative z-10 bg-gray-100 rounded-2xl m-4 pt-20 pb-10 lg:pt-[120px] lg:pb-20">
                    ...
                    <path
                        ...
                        {posts.map((value:Menus)=>
                            <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
                                <div className="mb-10 w-full">
                                    <h4 className="mb-9 text-lg font-semibold text-dark">{value.name}</h4>
                                    <ul>
                                        {value.sub_menu.map((subs:SubMenu)=>{
                                            return(
                                                <li>
                                                    {subs.type.name === 'menu'?
                                                        <Link to={`/menu/${subs.id}/${subs.type.name}`}
                        ...
                        <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
                            <div className="mb-10 w-full">
                                <h4 className="mb-9 text-lg font-semibold text-dark">Bizni Kuzatib boring</h4>
                                ...
                                <p className="text-base text-body-color">© 2023 Navoiy uran</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <span className="absolute left-0 bottom-0 z-[-1]">
          <svg width="217" height="229" viewBox="0 0 217 229" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                ...
                fill="url(#paint0_linear_1179_5)"></path>
            <defs>
          ...
          <svg width="75" height="75" viewBox="0 0 75 75" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                ...
                fill="url(#paint0_linear_1179_4)"></path>
            <defs>
